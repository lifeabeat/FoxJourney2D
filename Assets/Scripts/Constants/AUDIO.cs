...
{
	 public const string BGM_BOSSBATTLE = "Boss Battle";
	 public const string BGM_GAMECOMPLETE = "Game Complete";
	 public const string BGM_LEVELSELECT = "Level Select";
	 public const string BGM_LEVELVICTORY = "Level Victory";
	 ...
	 public const string BGM_PLAYERDEATH = "Player Death";
	 public const string BGM_PLAYERHURT = "Player Hurt";
	 public const string BGM_PLAYERJUMP = "Player Jump";
	 public const string BGM_TRAPSLAM = "TrapSlam";
	 public const string BGM_WARPJINGLE = "Warp Jingle";
}
